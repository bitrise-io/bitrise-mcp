...
var ListBuildDistributionVersions = bitrise.Tool{
	...
	Definition: mcp.NewTool("list_build_distribution_versions",
		...
		mcp.WithTitleAnnotation("List Build Distribution Versions"),
